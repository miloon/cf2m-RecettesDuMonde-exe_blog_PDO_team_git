...
if (empty($_POST['inserer'])) {
    ...
    $requetecontinent = $connexion->prepare("SELECT id, lintitule FROM recette_continent ORDER BY lintitule ASC;");
    ...
    try {
        ...
        INSERT INTO `recette_pays`(`lintitule`, `ladesc`, `continent_id`, `img`)
