...
FROM recette_pays p
  INNER JOIN recette_continent c
...
// exécution de la requête
    ...
    try{
        ...
        $prepare = $connexion->prepare("UPDATE `recette_pays` SET `lintitule`= :titre,`ladesc`= :ladesc,`continent_id`= :idcontinent,`img`= :limg WHERE `id`=$idpays");
